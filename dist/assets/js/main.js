...
/* harmony import */ var _portfolioObj__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./portfolioObj */ 360);
...
function createSlide(client, image) {
  ...
  setWidth(slideDiv, _portfolioObj__WEBPACK_IMPORTED_MODULE_1__[client].images);
...
function getImageSlide(client) {
  const maxImagePortfolio = _portfolioObj__WEBPACK_IMPORTED_MODULE_1__[client].images;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _portfolioObj__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./portfolioObj */ 360);
...
function fillContent(e) {
  ...
  h3.textContent = _portfolioObj__WEBPACK_IMPORTED_MODULE_0__[clientID].title;
  h6.textContent = _portfolioObj__WEBPACK_IMPORTED_MODULE_0__[clientID].tags;
  para.textContent = _portfolioObj__WEBPACK_IMPORTED_MODULE_0__[clientID].text;

  if (validationObjProp(_portfolioObj__WEBPACK_IMPORTED_MODULE_0__, clientID, 'site')) {
    setLink(_portfolioObj__WEBPACK_IMPORTED_MODULE_0__[clientID].site, 'site');
  }
  if (validationObjProp(_portfolioObj__WEBPACK_IMPORTED_MODULE_0__, clientID, 'repo')) {
    setLink(_portfolioObj__WEBPACK_IMPORTED_MODULE_0__[clientID].repo, 'repo');
  }
...
/* harmony import */ var _portfolioObj_json__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./portfolioObj.json */ 360);
...
function preloadImages() {
  Object.keys(_portfolioObj_json__WEBPACK_IMPORTED_MODULE_7__).forEach((client) => {
    preloadedImages[client] = [];
    for (let i = 1; i <= _portfolioObj_json__WEBPACK_IMPORTED_MODULE_7__[client].images; i += 1) {
...
/***/ 360:
/*!*****************************************!*\
  !*** ./src/assets/js/portfolioObj.json ***!
  \*****************************************/
/***/ ((module) => {

"use strict";
module.exports = JSON.parse('{"rivieras":{"title":"Rivieras Hotel","tags":"#JavaScript #HTML5 #CSS","text":"Desenvolvimento do código do site do motel Rivieras Hotel. Layout por King Propaganda.","site":"http://www.rivierashotel.com.br","images":3},"jagrao1":{"title":"Jagrao Brazil","tags":"#JavaScript #HTML5 #CSS #WordPress","text":"Desenvolvimento do site bilingue para exposição de produtos da exportadora de frutas Jagrão Brazil. Layout por Sergio Lima.","site":"http://jagraobrazil.com","images":3},"jagrao2":{"title":"Jagrao Brazil","tags":"#JavaScript #HTML5 #CSS #WordPress","text":"Repaginação do site da empresa Jagrao Brazil. Layout por 360º Agência Criativa.","site":"http://jagraobrazil.com","images":4},"itauna":{"title":"Itaúna Advisors","tags":"#JavaScript #HTML5 #CSS #WebDesign","text":"Site institucional da empresa Itaúna Advisors do RJ de constultoria financeira.","site":"https://www.itaunaconsultoria.com.br/","images":3},"mauaeconzo":{"title":"Maua & Conzo","tags":"#JavaScript #HTML5 #CSS #WordPress","text":"Site pensado e desenvolvido com o intuito de captação de novos clientes para a empresa. Para atingir o resultado de captação de clientes, fizemos diversas landing pages dentro do site para que cada uma pudesse ser divulgada individualmente junto ao buscadores. Layout por Junior Mendes.","site":"https://www.mauaeconzo.com.br/","images":3},"iris":{"title":"Iris Laboratories","tags":"#HTML5 #CSS #WordPress #WP-Plugins","text":"Site desenvolvido para a empresa norte-americana especializada em inspeção e remoção de amianto e mofos dentro de imóveis.","site":"http://www.irislaboratories.com/","images":4}}');
